#ifndef LIFE_CYCLE_HPP_
#define LIFE_CYCLE_HPP_
...
struct life_cycle_model {};

using namespace life_cycle::tags;
using namespace life_cycle::detail;

}

#endif  // LIFE_CYCLE_HPP_
