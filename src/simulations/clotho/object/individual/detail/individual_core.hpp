...
BOILER_PLATE_METHOD( void, initialize )() {
    initializer::InitWorker< BOILER_PLATE_SPECIALIZED_CLASS >::init( this );
}

BOILER_PLATE_METHOD( void, finalize )() {
    finalizer::FinalWorker< BOILER_PLATE_SPECIALIZED_CLASS >::init( this );
}
...
BOILER_PLATE_METHOD( typename BOILER_PLATE_SPECIALIZED_CLASS::properties_type *, getProperties)() {
    return &m_props;
}
